			...
			{comments?.map((comment) => {
				...
				return  comments? (
					<div
						...
						<ol><div className='card-content'>{comment?.comments}</div>
						<div className='card-content'>By {comment.player?.user.username} <p></p>{comment.player.id === parseInt(localStorage.getItem("playerId")) ?
