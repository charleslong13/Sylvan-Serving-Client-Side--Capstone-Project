                    ...
                    <div className="aboutUsBody">
                        <div className="card w-50 h-50" style={{ backgroundColor: '#2e8b57' }} >
                            ...
                            <div className="card-body">
                                ...
                                <b><div style={{marginTop: '100px'}}>
                                    Watch these if you are either new to Magic the Gathering or just new to the Commander format!
                                </div></b>
                                <iframe width="520" height="415"
                                    src="https://www.youtube.com/embed/wif9ppH5JpI">
                                </iframe>
                                <iframe width="520" height="415"
                                    src="https://www.youtube.com/embed/eaNjXcAqCAY">
                                </iframe>
